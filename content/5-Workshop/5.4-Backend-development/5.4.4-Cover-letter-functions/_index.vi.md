...
Trong bài này, chúng ta sẽ xây dựng chức năng **Cover Letter Generator**.

Khác với Resume (CV) là dữ liệu tĩnh ít thay đổi, Cover Letter (Thư xin việc) cần được tùy biến ("tailor") cho từng công ty và vị trí ứng tuyển. Đây là việc rất tốn thời gian nếu làm thủ công, nhưng lại là bài toán hoàn hảo cho AI.

### Luồng dữ liệu (Data Flow)
1.  **Input:** User cung cấp Tên công ty, Vị trí, và Mô tả công việc (Job Description - JD).
2.  **Process:** Backend ghép thông tin này thành một Prompt (Câu lệnh) gửi cho Claude 3.
3.  **Output:** AI trả về bài văn mẫu. Backend lưu vào DB và trả về Frontend.

---

## 1. Model (Entity Layer)

Vì một người dùng có thể tạo nhiều thư xin việc cho nhiều công ty khác nhau, nên `SK` (Sort Key) sẽ là duy nhất cho mỗi lá thư (dùng UUID).
...
* PK: USER#{userId}.
* SK: LETTER#{uuid} (Ví dụ: LETTER#550e8400-e29b...).

---

## 2. Repository (Data Access Layer)

Chúng ta cần các hàm để Lưu, Lấy danh sách, và Xóa thư.
...
Đây là phần quan trọng nhất: Cách nói chuyện với AI.
...
Hàm này cần xử lý nhiều API Endpoint hơn (List, Get One, Create, Delete).
